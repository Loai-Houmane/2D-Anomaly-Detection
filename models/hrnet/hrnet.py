...
#BackBone(put your backbone directory here)
backBone="C:/Users/houma/.cache/torch/hub/checkpoints/hrnetv2_w32_imagenet_pretrained.pth"
...
def _hrnet(arch, pretrained, progress, **kwargs):
    ...
    if pretrained:
        #changed the path to the expert model
